...
For 2017, it can be seen that eleven out of the twelve stocks are positive and only one stock ticker 'TERP' is negative in terms of the yearly return. On the other hand for the year 2018, most of the stocks are negative and only two stock tickers, 'ENPH' and 'RUN' is positive. 'DQ', the initail stock that Steve's parents were interested in had a great year with 199.4% return in 2017. But in 2018, the yearly return dropped to 62.6%. To understand these stocks little better, let's take few examples of the stock tickers from these twelve stocks and comapre their valuation for both the years below.
